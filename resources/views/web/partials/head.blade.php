...
<title>{{config('seo.title')}}&thinsp;/&thinsp;@if(trim($__env->yieldContent('seo_title')))@yield('seo_title')@else{{config('seo.title')}}@endif</title>
...
<meta property="og:title" content="@if(trim($__env->yieldContent('seo_title')))@yield('seo_title')&thinsp;/&thinsp;{{config('seo.title')}}@else{{config('seo.title')}}@endif">
...
<body class="antialised font-light text-base px-16 pb-48 max-w-7xl">